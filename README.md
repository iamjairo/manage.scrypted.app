...
A standalone Electron launcher app is available under [`server-app/`](./server-app/). See [`server-app/README.md`](./server-app/README.md) for setup, development, and packaging details.
